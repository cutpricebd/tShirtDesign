                ...
                <tbody>
                    ...
                    @endphp
                        <tr>
                            ...
                            <td class="tbl-line-height">{{ $settings_g['currency_symbol'] ?? '৳' }}{{ $order_product->selling_price }}</td>
                            <td class="tbl-line-height">{{$order_product->quantity}}</td>
                            <td class="tbl-line-height text-right">{{ $settings_g['currency_symbol'] ?? '৳' }}{{ $order_product->selling_price * $order_product->quantity }}</td>
                        </tr>
                    @endforeach
                    ...
                    <tr>
                        ...
                        <td class="tbl-line-height text-right">{{ $settings_g['currency_symbol'] ?? '৳' }}{{ $order->shipping_cost }}</td>
                    </tr>

                    <tr class="mb-5">
                        <td colspan="2" class="tbl-line-height pt-4"></td>
                        <td colspan="2" class="tbl-line-height pt-4">Grand total</td>
                        <td class="tbl-line-height text-right pt-4">{{ $settings_g['currency_symbol'] ?? '৳' }}{{ $order->order_total }}</td>
                    </tr>
