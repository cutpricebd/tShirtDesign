...
class Product extends Model
{
    ...
    public function getImgPathsAttribute(){
        if ($this->image == "digital_ocean"){
            return json_decode($this->image_path,true)??['original'=>null,'small'=>null,'medium'=>null,'large'=>null];
        }else return MediaRepo::sizes($this->image_path, $this->image);
    }
